...
class TestCircle(unittest.TestCase):
    ...
    def test_move(self):
        self.assertEqual(Circle(2, 4, self.circle1.radius),
                         self.circle1.move(1, 2))
        self.assertEqual(self.circle2, self.circle2.move(0, 0))
        self.assertEqual(Circle(-1, -6, self.circle3.radius),
                         self.circle3.move(-1, -10))
        self.assertEqual(Circle(1.5, 0.5, self.circle4.radius),
                         self.circle4.move(-1.5, 2.5))
